...
The charts highlight the prominent role of mixed ancestry characters. Even though they are a demographic minority, the relative share of mixed ancestry characters increases to `r percent(weight_count$percent[2])` when their textual presence is taken into account. The statistics affirm what is readily apparent from reading the text: characters with mixed ancestry feature prominently. In Faulkner's world, the very existence of such characters represented a threat. As Eric Sundquist explains, "The children of miscegenation not only threatened to blur the distinctions that made slavery possible, but the unions that produced them threatened to distort sexual relations and marriage itself, for black and white alike, into peculiar and tragic forms" [-@sundquistFaulknerHouseDivided1983 116]. What would be harder to detect without a statistical overview is that the attention to mixed ancestry characters does not reduce the focus on White characters, whose relative representation actually increases. Thus, while the text certainly complicates racial binarism, it is far more concerned with how interracial liaisons trouble Whiteness than what they might mean for Blackness.
